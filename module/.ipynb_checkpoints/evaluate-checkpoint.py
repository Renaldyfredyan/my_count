...
def evaluate(args):
    ...
    if 'SLURM_PROCID' in os.environ:
        ...
        world_size = int(os.environ.get('WORLD_SIZE', 1))  # Default to 1 if not found
        rank = int(os.environ.get('RANK', 0))              # Default to 0 if not found
        gpu = int(os.environ.get('LOCAL_RANK', 0))         # Default to 0 if not found
