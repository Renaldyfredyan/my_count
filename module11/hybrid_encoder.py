...
class HybridEncoder(nn.Module):
    def __init__(
        ...
        # Projections for different feature levels - Disesuaikan dengan output aktual
        self.conv_low = nn.Conv2d(256, emb_dim, 1)   # S3
        self.conv_mid = nn.Conv2d(512, emb_dim, 1)   # S4
        self.conv_high = nn.Conv2d(1024, emb_dim, 1) # S5
    ...
    def forward(self, s3, s4, s5):
        ...
        if len(s3.shape) == 4 and s3.shape[1] != s3.shape[3] and s3.shape[3] == 256:  # BHWC format
