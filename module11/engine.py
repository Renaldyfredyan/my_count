...
class efficient(nn.Module):
    ...
    def __init__(
        ...
        # Jika tidak menggunakan encoder, tambahkan projection layer
        if num_encoder_layers > 0:
            ...
            # Input projection untuk kasus tanpa encoder (sesuaikan dengan dimensi yang benar)
...
def build_model(args):
    ...
    assert args.backbone in ['grounding_dino', 'swin_base']  # Termasuk opsi 'swin_base'
