...
class DensityMapRegressor(nn.Module):
    ...
    def __init__(self, in_channels, reduction):
        ...
        # Tambahkan attention-based refinement
    ...
    def forward(self, x):
        # Refine features dengan attention
        attention_weights = self.attention_refine(x)
        refined_features = x * attention_weights
        
        # Lanjutkan dengan regressor yang sudah ada
        return self.regressor(refined_features)
